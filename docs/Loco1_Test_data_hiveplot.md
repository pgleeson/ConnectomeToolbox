...
=== "View info"
    ...
    **Locomotion 1** (Loco1)
    ...
    | Nodes in current view<br/>(8 total) <span style="color:#ffffff;">xxxxxxxxxxxxxxxxxxxxxxxxx</span>| Num cells in node<br/>(71 total) | Num in this dataset<br/>(11 total) | Cells in node |
    | --- | --- | --- | --- |
