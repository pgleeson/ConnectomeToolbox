...
=== "Chemical"
    ...
    { "file_path": "./assets/Test_Loco2_Chemical.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```{.plotly .no-auto-theme}
    { "file_path": "./assets/Test_Loco2_Electrical.json" }
    ```
...
=== "Acetylcholine"
    ...
    <br/>
    ```{.plotly .no-auto-theme}
    { "file_path": "./assets/Test_Loco2_Acetylcholine.json" }
    ```
...
=== "GABA"
    ...
    <br/>
    ```{.plotly .no-auto-theme}
    { "file_path": "./assets/Test_Loco2_GABA.json" }
    ```
