...
=== "Chemical"
    ...
    { "file_path": "./assets/Test_Neurons_Chemical.json" }
    ```
...
=== "Acetylcholine"
    ...
    <br/>
    ```{.plotly .no-auto-theme}
    { "file_path": "./assets/Test_Neurons_Acetylcholine.json" }
    ```
...
=== "GABA"
    ...
    <br/>
    ```{.plotly .no-auto-theme}
    { "file_path": "./assets/Test_Neurons_GABA.json" }
    ```
