...
!!! tip  "Choose View"
    ...
    <a href="../Test_data_graph"> Raw Data</a> - <a href="../Neurons_Test_data_graph"> Neurons</a> - <a href="../Pharynx_Test_data_graph"> Pharynx</a> - <a href="../Escape_Test_data_graph"> Escape Response Circuit</a> - <a href="../Full1_Test_data_graph"> Cook 2019 Fig 3</a> - <a href="../BrainmapA_Test_data_graph"> BrainMap A</a> - <a href="../Brainmap_Test_data_graph"> BrainMap B</a> - <a href="../Loco2_Test_data_graph"> Locomotion 2</a> - <b><a href="../NonpharyngealH_Test_data_graph"> Nonpharyngeal Neurons (herm)</a></b> - <a href="../MotorSomaticH_Test_data_graph"> Motor Neurons (somatic)</a> - <a href="../MotorMuscles_Test_data_graph"> Motor Neurons and muscles</a> - 

    <i>All **hermaphrodite** neurons except those in the pharynx</i>
=== "Chemical"

    ```{.plotly .no-auto-theme}
    { "file_path": "./assets/Test_NonpharyngealH_Chemical_graph.json" }
    ```

=== "Electrical"

    ```{.plotly .no-auto-theme}
    { "file_path": "./assets/Test_NonpharyngealH_Electrical_graph.json" }
    ```

=== "Acetylcholine"

    ```{.plotly .no-auto-theme}
    { "file_path": "./assets/Test_NonpharyngealH_Acetylcholine_graph.json" }
    ```

=== "GABA"

    ```{.plotly .no-auto-theme}
    { "file_path": "./assets/Test_NonpharyngealH_GABA_graph.json" }
    ```
