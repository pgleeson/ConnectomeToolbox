...
=== "Chemical"
    ...
    ```
    Of 79524 possible edges, 14 are connected, 9 are mirrored - 64.29% 
...
=== "Electrical"
    ...
    ```
    Of 79524 possible edges, 4 are connected, 1 are mirrored - 25.00% 
...
=== "Acetylcholine"
    ...
    ```
    Of 79524 possible edges, 11 are connected, 6 are mirrored - 54.55% 
...
=== "GABA"
    ...
    ```
    Of 79524 possible edges, 3 are connected, 3 are mirrored - 100.00% 
