...
=== "Chemical"
    ...
    { "file_path": "./assets/Test_NonpharyngealH_Chemical_symm.json" }
    ```
    Of 79524 possible edges, 14 are connected, 9 are mirrored - 64.29% (bilateral symmetry index: 0.6429) 

=== "Electrical"

    <br/>
    ```{.plotly .no-auto-theme}
    { "file_path": "./assets/Test_NonpharyngealH_Electrical_symm.json" }
    ```
    Of 79524 possible edges, 4 are connected, 1 are mirrored - 25.00% (bilateral symmetry index: 0.2500) 

=== "Acetylcholine"

    <br/>
    ```{.plotly .no-auto-theme}
    { "file_path": "./assets/Test_NonpharyngealH_Acetylcholine_symm.json" }
    ```
    Of 79524 possible edges, 11 are connected, 6 are mirrored - 54.55% (bilateral symmetry index: 0.5455) 

=== "GABA"

    <br/>
    ```{.plotly .no-auto-theme}
    { "file_path": "./assets/Test_NonpharyngealH_GABA_symm.json" }
    ```
    Of 79524 possible edges, 3 are connected, 3 are mirrored - 100.00% (bilateral symmetry index: 1.0000) 
