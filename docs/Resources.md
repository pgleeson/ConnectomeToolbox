...
[WormBase](https://www.wormbase.org/) is a comprehensive resource providing accurate, current information on the genetics, genomics, and biology of _C. elegans_ and related nematodes. It contains information spanning the genomic sequence, genes and their products, gene expression patterns, and neuronal connectivity, making it useful to researchers across many specialities.
