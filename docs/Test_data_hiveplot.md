...
=== "View info"
    ...
    **Raw Data** (Raw)
    ...
    | Nodes in current view<br/>(637 total) <span style="color:#ffffff;">xxxxxxxxxxxxxxxxxxxxxxxxx</span>| Num cells in node<br/>(637 total) | Num in this dataset<br/>(21 total) | Cells in node |
    | --- | --- | --- | --- |
