...
=== "View info"
    ...
    **Raw Data** (Raw)
    ...
    | Nodes in current view<br/>(639 total) <span style="color:#ffffff;">xxxxxxxxxxxxxxxxxxxxxxxxx</span>| Num cells in node<br/>(639 total) | Num in this dataset<br/>(21 total) | Cells in node |
    | --- | --- | --- | --- |
