...
\begin{longtable}{>{\raggedright\arraybackslash}p{0.12\textwidth}>{\raggedright\arraybackslash}p{0.16\textwidth}>{\raggedright\arraybackslash}p{0.30\textwidth}>{\raggedright\arraybackslash}p{0.30\textwidth}}
  ...
  \multirow{3}{\linewidth}{\cite{White1986}}  & White et al. 1986 N2U/adult \newline \href{https://openworm.org/ConnectomeToolbox/White_A_data}{Matrix} | \href{https://openworm.org/ConnectomeToolbox/Validation#whiteetal1986}{Validation} \newline  & TODO \newline &  TODO \\
  & White et al. 1986 JSH/L4 \newline \href{https://openworm.org/ConnectomeToolbox/White_L4_data}{Matrix} | \href{https://openworm.org/ConnectomeToolbox/Validation#whiteetal1986}{Validation} \newline  & TODO \newline &  TODO \\
